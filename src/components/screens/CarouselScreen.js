...
const styles = StyleSheet.create({
  container: {
    marginTop:
      Platform.OS === "ios" ? responsiveHeight(6.25) : responsiveHeight(4),
  },
  imageContainer: {
    width: width,
  ...
  image: {
    ...
    height:
      Platform.OS === "ios" ? responsiveHeight(53.75) : responsiveHeight(58),
  },
  indicatorContainer: {
    flexDirection: "row",
    justifyContent: "center",
  ...
  button: {
    ...
    borderRadius: 5,
    marginTop:
      Platform.OS === "ios" ? responsiveHeight(5) : responsiveHeight(4.125),
  },
  buttonText: {
    color: "#fff",
